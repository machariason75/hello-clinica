...
import { CheckCircle2, Lock, ArrowRight, GraduationCap, History, StickyNote, Bell , Bookmark , MessagesSquare } from "lucide-react";
    ...
    <PageTransition>
      ...
      <Section ariaLabel="Account">
        <div className="mx-auto max-w-2xl space-y-6">
          ...
          <Link href="/account/engagements" className="surface-card group flex items-center gap-3 p-6 transition hover:shadow-md">
